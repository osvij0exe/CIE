...
namespace CIE.WebApp.Services.Interfaces
{
    public interface ICie10Services
    {
        ...
        Task<PaginationBaseResponse<Cie10ResponseDto>> MedicalIssueListAsync(string? code,string? descripcion,string? sexo,string? claveCategoria,int page = 1,int rows = 10);
